...
def makePickBottleSM(dataSM):
  ...
  with sm:
          ...
          #smach.StateMachine.add('MOVE_HOME_PICK_BOTTLES',MoveHomePickBottles(dataSM),
          #              transitions = {'success':'DETECT_BOTTLE',
          #              'error':'error'})
          sm.userdata.sm_user_object_pose = dataSM.pick_pose
         
          print("AAA=", dataSM.pick_pose)
